...
Puzzler is a mobile-first arcade of quick games. The current live game is Flag Blitz: identify country flags in a 10-question Classic run, an Unlimited streak run, or a 60-second Speed Match board.
