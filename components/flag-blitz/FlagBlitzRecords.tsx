  ...
  return (
    <section className="mt-8" aria-labelledby="flag-blitz-records-title">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-5">
        ...
        <Record value={records.bestSpeedMatchUnlimitedScore} label="Best live" tone="text-violet-300" description="Flag Marathon: flags found on the untimed replenishing board. Choose Save & see results to record a run." />
      </div>
    </section>
  );
}
